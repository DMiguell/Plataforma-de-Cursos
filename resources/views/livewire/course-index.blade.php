    ...
    <div class="bg-gray-200 py-4 mb-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex">
            ...
            <div class="relative mr-4" x-data="{ open:false }">
                <button class="px-4 bg-white shadow block h-12 rounded-lg overflow-hidden focus:outline-none  text-gray-700" x-on:click="open = true">
                    <i class="fas fa-tags text-sm mr-2"></i>
                    Categoria
                    <i class="fas fa-angle-down text-sm ml-2"></i>
                </button>
                {{-- Dropdown-Body --}}
                <div x-show="open" x-on:click.away="open = false" class="absolute right-0 w-40 mt-2 py-2 bg-white border rounded shadow-x1 ">
        ...
        @foreach ($courses as $course)
            <article class="bg-white shadow-lg rounded overflow-hidden">
                ...
                <div class="px-6 py-4">
                    ...
                    <a href="{{route('courses.show', $course)}}" class=" w-full bg-blue-500 mt-2 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded block text-center">Mas informacion</a>
                </div>
            </article>
        @endforeach
    </div>
